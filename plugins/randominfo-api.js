...
if (command == 'covidindo') {
    let src = await (await fetch(`https://saipulanuar.ga/api/info/covidindo?provinsi=${text}`)).json()
    let xxx = src.result
    let xs = xxx.provinsi
    let xa = xxx.kasus
    let xt = xxx.meninggal
    let xm = xxx.sembuh
...
if (command == 'covidworld') {
    let src = await (await fetch(`https://saipulanuar.ga/api/info/covidworld`)).json()
    let xxx = src.result
...
if (command == 'gempa') {
    let src = await (await fetch(`https://saipulanuar.ga/api/info/gempa`)).json()
    let xxx = src.result
    let xs = xxx.waktu
    let xa = xxx.mag
    let pa = xxx.kedal
...
if (command == 'randomcerpen') {
    let src = await (await fetch(`https://saipulanuar.ga/api/cerpen/random`)).json()
    let xxx = src.result
    let xs = xxx.judul
    let xa = xxx.kar
    let pa = xxx.kat
