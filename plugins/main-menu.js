  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    ...
	    {title: `☄️🌧️ Sc Ini Direcode Oleh Abdul Masuk Surga `, rowId: "p", description: "Jangan Lupa Ibadah"},
	...
	rows: [
	  ...
	  {title: `💡¦ Group Official Elaina`, rowId: ".groupbot", description: 'Jangan lupa mampir ya...'},
...
let tek = `
 ...
 │*Sc Ini Direcode Oleh Abdul Masuk Surga.*
 │*Jangan Lupa Ibadah Yg Benar Kawand*
 ╰─────────────⬣
`
const listMessage = {
  text: tek,
