...
conn.sendButton(m.chat, '▷ʙᴏᴛ sᴛᴀᴛᴜs◁', sts, [['OWNER', '.owner'],['SPEED TEST', '.testspeed']], m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https//wa.me/6285869074622?text=Hᴀʟᴏ+ɢᴀɴᴛᴇɴɢᴋᴜ',
    mediaType: 2, 
    description: 'wa.me/6285869074622?text=Hᴀʟᴏ+ɢᴀɴᴛᴇɴɢᴋᴜ',
    title: "Iɴɪ Fᴀᴄᴇʙᴏᴏᴋ Gᴡ!",
    body: wm,
    thumbnail: fs.readFileSync('./thumbnail.jpg'),
    sourceUrl: 'https://facebook.com/abdulmalik.rizky.5'
     }}
  })
